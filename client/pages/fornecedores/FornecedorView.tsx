        ...
        <div className="space-y-6">
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              <Badge
                className={`${fornecedor.ativo ? "bg-green-500" : "bg-red-500"} text-white mb-2`}
              >
          ...
          <div className="bg-white p-4 rounded-lg border">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              {fornecedor.nome_responsavel && (
                <DataField
                  label="Responsável"
                  value={fornecedor.nome_responsavel}
                />
              )}
            </div>
          </div>
          ...
          <div className="bg-white p-4 rounded-lg border">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <DataField
                ...
                value={
                  <a
                    href={`tel:${fornecedor.ddi}${fornecedor.telefone}`}
                    className="text-blue-600 hover:underline"
                  >
          ...
          <div className="bg-white p-4 rounded-lg border">
            ...
            <div className="grid grid-cols-2 gap-4">
              <DataField
                ...
                value={formatDate(fornecedor.data_cadastro)}
              />
              <DataField
