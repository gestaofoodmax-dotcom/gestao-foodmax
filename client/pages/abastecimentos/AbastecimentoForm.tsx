        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="space-y-4 bg-white p-4 rounded-lg border">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-green-600">Contato do Estabelecimento</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          <div className="space-y-4 bg-white p-4 rounded-lg border">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-purple-600">Endereço do Estabelecimento</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <Label>CEP</Label>
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    className={cn(
                      "foodmax-input",
                      (validationErrors.uf || errors.uf) && "border-red-500",
                    )}
                    maxLength={2}
                  />
              ...
              <div>
                ...
                <Input
                  ...
                  className={cn(
                    "foodmax-input",
                    (validationErrors.pais || errors.pais) && "border-red-500",
                  )}
                  defaultValue="Brasil"
                />
                {errors.pais && (
