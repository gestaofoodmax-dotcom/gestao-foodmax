        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 w-full">
            ...
            <div className="mt-3 text-xs text-blue-600">
              ...
              <p>
                • Formato de data: dd/mm/yyyy (ou dd/mm/yyyy hh:mm:ss para campos com hora). As datas são interpretadas no fuso horário de Brasília/DF (UTC-03), preservando o dia e o horário informado.
              </p>
              {Array.isArray(extraNotes) && extraNotes.length > 0 && (
                <div className="mt-2">
                  <h5 className="font-medium text-blue-900">Observações específicas:</h5>
